...
const EventDetails = () => {
    ...
    const cancelTime = moment(moment(eventData.bookingDate).format('YYYY-MM-DD hh:mm:ss')).subtract(0, "hour").format('YYYY-MM-DD hh:mm:ss')
            ...
            <div className="header_padd">
                <div className="tips_block">
                    <Card>
                        ...
                        {
                            eventData.isDeleted === true ? (<div className="schedule_booking_footer">
